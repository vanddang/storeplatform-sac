...
/**
 * 
 * ImIDPManagerConstants class
 * 
 * Updated on : 2014. 1. 6. Updated by : Jeon.ByungYoul, SK planet.
 */
public interface ImIDPManagerConstants {
	...
	public static final String IDP_PARAM_PASSWD_TYPE_NORMAL = "1";
	public static final String IDP_PARAM_PASSWD_TYPE_TEMP = "2";

	public static final String IDP_PARAM_REGIST_AUTH_TYPE_MOBILE = "1";
	public static final String IDP_PARAM_REGIST_AUTH_TYPE_EMAIL = "2";

	public static final String IDP_PARAM_LANG_CODE = "KOR";

	public static final String IDP_PARAM_USER_TN_TYPE_MOBILE = "M";

	public static final String IDP_PARAM_USER_TN_NATION_CD = "82";
	...
	// public static final String IDP_PARAM_OPERATION_MODE_DEV = "staging";
