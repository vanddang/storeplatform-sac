...
public class CouponContentService {
	 ...
	 *            [DpCouponInfo dpCouponInfo, List<DpItemInfo> dpItemlist]
	 * @return Boolean result
	 * @throws CouponException
	 */
	public boolean processForCouponCSP(CouponContainer container, String txType) throws CouponException { // Coupon
																										  // txType =
																										  // "cp"일 경우
		// 호출
		...
		couponInfo = container.getDpCouponInfo();
		...
		if (container != null) {
			...
			itemInfoList = container.getDpItemInfo();
			...
			throw new CouponException(CouponConstants.COUPON_IF_ERROR_CODE_DB_ETC, "Container is NULL!!", null);
		}
		// watch.stop();
	 ...
	 * @throws CouponException
	 */
	private boolean validateCouponInfo(DpCouponInfo couponInfo) throws CouponException {
	...
	private boolean setTbDpProdInfoValue(DpCouponInfo couponInfo, List<DpItemInfo> itemInfoList,
			List<TbDpProdInfo> tblDpProdList, String txType) throws CouponException {
	...
	private boolean setTbDpShpgProdListValue(DpCouponInfo couponInfo, List<DpItemInfo> itemInfoList,
			List<TbDpShpgProdInfo> tbDpShpgProdList, String txType) throws CouponException {
	...
	private boolean setTbDpProdDescListValue(DpCouponInfo couponInfo, List<DpItemInfo> itemInfoList,
			List<TbDpProdDescInfo> tbDpProdDescList, String txType) throws CouponException {
	...
	private boolean setTbDpProdRshpValue(DpCouponInfo couponInfo, List<DpItemInfo> itemInfoList,
			List<TbDpProdRshpInfo> tbDpProdRshpList, String txType) throws CouponException {
	...
	private boolean setTbDpProdOptValue(DpCouponInfo couponInfo, List<DpItemInfo> itemInfoList,
			List<TbDpProdOpt> tbDpProdOptList, String txType) throws CouponException {
	...
	private boolean setTbDpTenantProdListValue(DpCouponInfo couponInfo, List<DpItemInfo> itemInfoList,
			List<TbDpTenantProdInfo> tbDpTenantProdList, String txType) throws CouponException {
	...
	private boolean setTbDpTenantProdPriceListValue(DpCouponInfo couponInfo, List<DpItemInfo> itemInfoList,
			List<TbDpTenantProdPriceInfo> tbDpTenantProdPriceList, String txType) throws CouponException {
	 ...
	 * @throws CouponException
	 */
	private boolean validateBusinessPartner(DpCouponInfo couponInfo) throws CouponException {
	...
	// * @throws CouponException
	// */
	// private boolean validateCatalog(ContentInfo cInfo) throws CouponException {
	 ...
	 * @throws CouponException
	 */
	public boolean processForCouponStatus(CouponParameterInfo couponParameterInfo) throws CouponException { // Coupon
																											// txType =
																											// "st"일 경우
																											// 호출
	 ...
	 * @throws CouponException
	 */
	private String getDPStatusCode(String coupnStatus) throws CouponException {
		String dpStatusCode = "";
