...
public class LoginServiceImpl implements LoginService {
	 ...
	 * 
	 * @see
	 * com.skplanet.storeplatform.sac.member.user.service.LoginService#authorizeV3(com.skplanet.storeplatform.sac.common
	 * .header.vo.SacRequestHeader, com.skplanet.storeplatform.sac.client.member.vo.user.AuthorizeV3SacReq)
	 */
	@Override
	public AuthorizeV3SacRes authorizeV3(SacRequestHeader requestHeader, @Valid @RequestBody AuthorizeV3SacReq req) {
		...
		AuthorizeV3SacRes res = new AuthorizeV3SacRes();
		res.setTrxNo(req.getTrxNo());
