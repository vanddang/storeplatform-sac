...
public class DeviceServiceImpl implements DeviceService {
	...
	public void insertDeviceInfo(String userKey, DeviceInfo deviceInfo) throws Exception {
		...
		logger.info(":::::::::::: deviceInfo :::::::::::::: {}", createDeviceReq.toString());
		logger.info(":::::::::::: deviceInfo :::::::::::::: {}", createDeviceReq.getUserMbrDevice().toString());
	...
	public void mergeDeviceInfo(DeviceInfo req) throws Exception {
		...
		} else if (deviceModelNo != null && !deviceModelNo.equals(userMbrDevice.getDeviceModelNo())) {
	...
	public DeviceInfo getConverterDeviceInfo(UserMbrDevice userMbrDevice) {
		...
		deviceInfo.setStartDate(userMbrDevice.getStartDate());
	...
	public UserMbrDevice getConverterUserMbrDeviceInfo(DeviceInfo deviceInfo) {
		...
		userMbrDevice.setStartDate(deviceInfo.getStartDate());
		userMbrDevice.setDeviceAccount(deviceInfo.getDeviceAccount());
