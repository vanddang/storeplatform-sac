 ...
 */
public class TestMdnChecker implements PurchaseOrderChecker {
	...
	public boolean checkAndSetInfo(PurchaseOrder purchaseInfo) {
		...
		if (this.dummyService.isTestMdn(purchaseInfo.getTenantId(), purchaseInfo.getPurchaseMember().getDeviceId())) {
