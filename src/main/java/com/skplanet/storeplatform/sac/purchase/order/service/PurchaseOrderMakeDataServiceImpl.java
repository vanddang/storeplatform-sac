...
public class PurchaseOrderMakeDataServiceImpl implements PurchaseOrderMakeDataService {
	...
	public List<PrchsProdCnt> makePrchsProdCntList(List<PrchsDtlMore> prchsDtlMoreList, String statusCd) {
		...
		// TAKTEST:: QA 테스트
		// if (StringUtils.equalsIgnoreCase(this.envServerLevel, PurchaseCDConstants.ENV_SERVER_LEVEL_QA)
		// || StringUtils.equalsIgnoreCase(this.envServerLevel, PurchaseCDConstants.ENV_SERVER_LEVEL_LOCAL)) {
		// if (StringUtils.equalsIgnoreCase(this.envServerLevel, PurchaseCDConstants.ENV_SERVER_LEVEL_QA)) {
		// return null;
		// }
	...
	public List<MembershipReserve> makeMembershipReserveList(List<PrchsDtlMore> prchsDtlMoreList,
		...
		membershipReserve.setPayMethodVdtyDt(mileageSubInfo.getPayMethodVdtyDt()); // 적립금 유효일
