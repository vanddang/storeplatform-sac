...
public class PaymethodUtil extends PurchaseConstants
{
	...
	static {
		...
		convert2StoreMap.put(PAYPLANET_PAYMENT_METHOD_SYRUPPAY_18, PAYMENT_METHOD_SYRUP_PAY); // Syrup Pay
		...
		convert2PayPlanetMap.put(PAYMENT_METHOD_SYRUP_PAY, PAYPLANET_PAYMENT_METHOD_SYRUPPAY_18); // Syrup Pay
