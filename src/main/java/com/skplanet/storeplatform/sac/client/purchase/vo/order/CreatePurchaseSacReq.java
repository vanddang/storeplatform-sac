...
public class CreatePurchaseSacReq extends CommonInfo {
	...
	@Valid
	private List<PurchaseUserKeyInfo> receiverList; // biz상품 수신자 목록
	 ...
	 */
	public List<PurchaseUserKeyInfo> getReceiverList() {
	 ...
	 */
	public void setReceiverList(List<PurchaseUserKeyInfo> receiverList) {
