...
public class Search extends CommonInfo {
	...
	public String getAppVerCd() {
		return this.appVerCd;
	}

	public void setAppVerCd(String appVerCd) {
		this.appVerCd = appVerCd;
	}
	...
	public String getMusicAlbumNm() {
		return this.musicAlbumNm;
	}

	public void setMusicAlbumNm(String musicAlbumNm) {
		this.musicAlbumNm = musicAlbumNm;
	}
	...
	public String getParticCnt() {
		return this.particCnt;
	}

	public void setParticCnt(String particCnt) {
		this.particCnt = particCnt;
	}
