...
public class MusicDetailServiceImpl implements MusicDetailService {
    ...
    public MusicDetailRes getMusicDetail(MusicDetailReq req) {
        ...
        music.setServiceList(new ArrayList<com.skplanet.storeplatform.sac.client.product.vo.intfmessage.product.Service>(Arrays.asList(new com.skplanet.storeplatform.sac.client.product.vo.intfmessage.product.Service("mp3", "support"), new com.skplanet.storeplatform.sac.client.product.vo.intfmessage.product.Service("bell", "support"), new com.skplanet.storeplatform.sac.client.product.vo.intfmessage.product.Service("ring", "support"))));
