...
public class VodDetail extends CommonInfo {
	 ...
	 * 			일반화질 파일용량.
	 */
	public void setNmFileSize(Double nmFileSize) {
	 ...
	 * 			SD화질 파일용량.
	 */
	public void setSdFileSize(Double sdFileSize) {
