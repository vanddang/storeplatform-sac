 ...
 */
package com.skplanet.storeplatform.sac.display.device.vo;
...
public class DeviceProfile extends CommonInfo {
	...
	/**
	 * @return the makeCompNm
	 */
	public String getMakeCompNm() {
		return this.makeCompNm;
	}

	/**
	 * @param makeCompNm
	 *            the makeCompNm to set
	 */
	...
	/**
	 * @return the lcdSizeNm
	 */
	public String getLcdSizeNm() {
		return this.lcdSizeNm;
	}

	/**
	 * @param lcdSizeNm
	 *            the lcdSizeNm to set
	 */
	...
	/**
	 * @return the supportedHardwareMap
	 */
	public Map<String, Object> getSupportedHardwareMap() {
		return this.supportedHardwareMap;
	}

	/**
	 * @param supportedHardwareMap
	 *            the supportedHardwareMap to set
	 */
