...
public class BannerDefault {
	...
	/**
	 * @return the bnrInfoTypeCd
	 */
	public String getBnrInfoTypeCd() {
		return this.bnrInfoTypeCd;
	}

	/**
	 * @param bnrInfoTypeCd
	 *            the bnrInfoTypeCd to set
	 */
	...
	/**
	 * @return the sampleUrlHq
	 */
	public String getSampleUrlHq() {
		return this.sampleUrlHq;
	}

	/**
	 * @param sampleUrlHq
	 *            the sampleUrlHq to set
	 */
	public void setSampleUrlHq(String sampleUrlHq) {
		this.sampleUrlHq = sampleUrlHq;
	}
