...
/**
 * 음원 컨텐츠 Default Value Object.
 * 
 * Updated on : 2014. 01. 16. Updated by : 윤주영, SK 플래닛.
 */
public class MusicContentsDTO {
	...
	private String epsdProdId;
	private String outsdContentsId;
	private String prodNm;
	private String prodGrdDd;
	...
	public String getProdGrdDd() {
		return this.prodGrdDd;
	}

	public void setProdGrdDd(String prodGrdDd) {
		this.prodGrdDd = prodGrdDd;
	}
	...
	public void setFilePos(int fileSize) {
