...
public class MusicDetail {
    ...
    public String getDpPgRatioCd() {
        return dpPgRatioCd;
    }

    public void setDpPgRatioCd(String dpPgRatioCd) {
        this.dpPgRatioCd = dpPgRatioCd;
    }
    ...
    public boolean isBellSprtYn() {
        return bellSprtYn;
    }

    public void setBellSprtYn(boolean bellSprtYn) {
        this.bellSprtYn = bellSprtYn;
    }

    public boolean isColorringSprtYn() {
