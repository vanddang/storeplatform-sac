...
public class DisplayConstants {
	...
	/** 앨범 썸네일. */
	public static final String DP_SOURCE_TYPE_ALBUM_THUMBNAIL = "albumThumbnail";
	/** 가수 썸네일. */
	public static final String DP_SOURCE_TYPE_ARTIST_THUMBNAIL = "artistThumbnail";
	/** 원본. */
	...
	public static final String DP_SOURCE_TYPE_CARDIMG = "cardimg";
	public static final String DP_SOURCE_TYPE_LANDIMG = "landimg";
	...
	public static final String DP_SHOPPING_BRAND_NORMAL_ALL = "normalAll";
	...
	public static final String DP_PACKETFEE_TYPE_FREE = "free"; // 무료 과금
    ...
    public static final String DP_MUSIC_MP3_META_CLASS_CD = "CT25";
	/**
	 * 일반 컬러링 메타 클래스 코드.
	 */
