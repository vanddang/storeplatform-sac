...
public class UserReflectServiceFake implements UserReflectService {
	 ...
	 * 
	 * @see
	 * com.skplanet.storeplatform.sac.other.feedback.service.UserReflectService#reflectUser(com.skplanet.storeplatform
	 * .sac.other.feedback.vo.UserToBeReflected)
	 */
	@Override
