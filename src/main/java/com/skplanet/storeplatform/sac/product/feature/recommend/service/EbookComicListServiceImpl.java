 ...
 */
public class EbookComicListServiceImpl implements EbookComicListService {
	 ...
	 */
	@Override
	public RecommendProductResponse searchEbookComicList(RecommendProductRequest requestVO) {
