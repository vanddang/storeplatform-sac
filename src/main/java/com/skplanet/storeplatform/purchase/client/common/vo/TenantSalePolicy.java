...
public class TenantSalePolicy extends CommonInfo {
	...
	// 정책 조회 조건들
	private boolean ignoreTenantProdGrpCd; // 정책 기준 테넌트상품그룹코드 무시여부 (Y/N)
	private String prodId; // 상품ID
	private String parentProdId; // 모상품ID (인앱 경우 AID)

	// 추가 조건
	private String extraUnitCd; // 추가 정책처리 코드
	private String extraValue; // 추가 정책 메시지
	 ...
	 * Gets extra unit cd.
	 *
	 * @return the extra unit cd
	 */
	public String getExtraUnitCd() {
		return extraUnitCd;
	}
	 ...
	 *            the extra unit cd
	 */
	public void setExtraUnitCd(String extraUnitCd) {
		this.extraUnitCd = extraUnitCd;
	}
