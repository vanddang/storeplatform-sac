...
public class Payment extends CommonInfo {
	...
	private String limtMbrYn; // 한도가입자 여부 Y/N
	...
	/**
	 * @return the limtMbrYn
	 */
	public String getLimtMbrYn() {
		return this.limtMbrYn;
	}

	/**
	 * @param limtMbrYn
	 *            the limtMbrYn to set
	 */
	public void setLimtMbrYn(String limtMbrYn) {
		this.limtMbrYn = limtMbrYn;
	}
