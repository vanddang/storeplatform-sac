...
@Transactional
public class UserSearchMdnTest {
	...
	public void shouldObtainUserDetail() throws Exception {
		...
		new TestCaseTemplate(this.mockMvc).url("/user/search/searchMdn/v1").httpMethod(HttpMethod.POST)
				.addHeaders("x-store-auth-info", "authKey=114127c7ef42667669819dad5df8d820c;ist=N")
				.requestBody(new RequestBodySetter() {
					@Override
					public Object requestBody() {
						UserSearchMdnRequestVO reqVo = new UserSearchMdnRequestVO();
						reqVo.setUserID("seoguman");
						return reqVo;
					}
				}).success(UserSearchMdnResponseVO.class, new SuccessCallback() {
					@Override
					public void success(Object result, HttpStatus httpStatus, RunMode runMode) {

						System.out.println("### HTTP STATUS1 : " + httpStatus);

						UserSearchMdnResponseVO resultObj = (UserSearchMdnResponseVO) result;
