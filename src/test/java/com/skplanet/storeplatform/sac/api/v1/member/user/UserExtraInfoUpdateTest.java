...
public class UserExtraInfoUpdateTest {
	private static final Logger logger = LoggerFactory.getLogger(UserExtraInfoUpdateTest.class);
	 ...
	 */
	@Test
	public void aUpdateUserExtraInfo() {

		new TestCaseTemplate(this.mockMvc).url("/member/user/modifyAdditionalInformation/v1")
