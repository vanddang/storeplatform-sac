...
import com.skplanet.storeplatform.sc.client.vo.PaymentListVO;
...
public class PaymentListTest extends AbstractTransactionalJUnit4SpringContextTests {
	...
	public void shouldObtainPaymentList() throws Exception {
		new TestCaseTemplate(this.mockMvc).url("/bypass/payment/search/1").httpMethod(HttpMethod.POST)
				...
				}).success(PaymentListVO.class, new SuccessCallback() {
					@Override
					public void success(Object result, HttpStatus httpStatus, RunMode runMode) {
						PaymentListVO paymentListVO = (PaymentListVO) result;
