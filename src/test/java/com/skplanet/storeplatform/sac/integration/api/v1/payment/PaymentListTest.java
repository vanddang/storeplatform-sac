...
import com.skplanet.storeplatform.sc.client.payment.PaymentProto.PaymentList;
...
public class PaymentListTest {
	...
	public void shouldObtainPaymentList() throws Exception {
		StorePlatformAPIinvokor.create().url(TestConstants.SAC_URL + "/bypass/payment/search/1").method(HttpPost.class)
