...
public class DeviceControllerTest {
	...
	@Test
	public void searchProductProvisioning_정액제상품() throws Exception {
		//정액제 상품 프로비저닝
		this.mvc.perform(
				get("/display/device/product/provisioning/get/v1?deviceModelNo=SHV-E210S&list=H002795912&productType=normal")
