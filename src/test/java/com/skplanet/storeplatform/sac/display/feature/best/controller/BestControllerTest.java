...
public class BestControllerTest {
	...
	@Test
	public void bestDownloadList_RNK000000006_DP18() throws Exception {
		
		//RNK000000006 / DP18 | TV 방송
		//
		this.mvc.perform(
				get("/display/feature/best/download/list/v1?listId=RNK000000006&topMenuId=DP18&offset=1&count=50")
	...
	@Test
	public void bestContentsList_RNK000000006_DP18() throws Exception {
	...
	public void I03000001_2_1_1_BEST앱상품조회_인기신규() throws Exception {
		...
		this.mvc.perform(
				get("/display/feature/best/app/list/v1?listId=RNK000000001&offset=1&count=2")
				.accept(MediaType.parseMediaType("application/json;charset=UTF-8"))
				.header("x-sac-device-info", "model=\"SHW-M110S\", dpi=\"320\", resolution=\"480*720\", os=\"Android/4.0.4\", pkg=\"sac.store.skplanet.com/37\", svc=\"SAC_Client/4.3\"")
				.header("x-sac-network-info", "operator=\"unknown/unknown\", simOperator=\"450/05\", type=\"wifi\"")
				)
