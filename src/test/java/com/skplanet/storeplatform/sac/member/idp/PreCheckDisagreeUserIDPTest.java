...
public class PreCheckDisagreeUserIDPTest {

	private static final Logger LOGGER = LoggerFactory.getLogger(PreCheckDisagreeUserIDPTest.class);
		...
		new TestCaseTemplate(this.mockMvc).url("/member/idp/provisioning/v1").httpMethod(HttpMethod.POST)
				.requestBody(new RequestBodySetter() {
					...
					public Object requestBody() {
						...
						req.setCmd("RXPreCheckDisagreeUserIDP");
						...
						resultMap.put("user_id", "tstoretest4010");
						resultMap
								.put("user_ci",
