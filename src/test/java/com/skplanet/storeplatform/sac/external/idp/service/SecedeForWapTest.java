...
/**
 * IDP - 모바일 회원탈퇴, EC 로컬 서버가 8210 포트로 떠 있을 때만 성공
 * 
...
public class SecedeForWapTest {

	private static final Logger logger = LoggerFactory.getLogger(SecedeForWapTest.class);
