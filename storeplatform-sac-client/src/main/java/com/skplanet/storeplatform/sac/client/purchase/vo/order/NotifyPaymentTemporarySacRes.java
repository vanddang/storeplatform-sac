...
public class NotifyPaymentTemporarySacRes extends CommonInfo {
	...
	/**
	 */
	public NotifyPaymentTemporarySacRes() {
	}
	 ...
	 *            msg
	 */
	public NotifyPaymentTemporarySacRes(String code, String msg) {
		this.code = code;
		this.msg = msg;
	}
