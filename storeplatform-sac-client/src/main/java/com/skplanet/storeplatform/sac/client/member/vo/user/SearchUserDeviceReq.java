...
public class SearchUserDeviceReq extends CommonInfo {
	 ...
	 * 디바이스 키.
	 */
	private List<SearchUserDevice> searchUserDeviceReqList;

	public List<SearchUserDevice> getSearchUserDeviceReqList() {
		return this.searchUserDeviceReqList;
	}

	public void setSearchUserDeviceReqList(List<SearchUserDevice> searchUserDeviceReqList) {
