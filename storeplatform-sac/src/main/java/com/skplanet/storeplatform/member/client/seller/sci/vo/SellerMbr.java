 ...
 */
public class SellerMbr extends CommonInfo implements Serializable {
	...
	/**
	 * 판매자 구분 코드. ex) US010101(개인) , US010102(개인사업자) , US010103(법인사업자)
	 * 
	...
	/**
	 * 판매자 분류 코드. ex) US011301(무료 ), US011302(유료) , US011303(BP)
	 * 
	...
	/** 마지막 로그인일시. ex(YYYYMMDDHH24MISS) */
	private String loginDate; // tb_us_sellermbr_login_info 테이블에서 가지고오기

	/**
	 * 마지막 로그인일시 리턴한다.
	 * 
	 * @return loginDate - 마지막 로그인일시
	 */
	...
	/** 탈퇴사유 코드. */
	private String secedeReasonCode; // BOLTER_REASON_CD

	/** 탈퇴사유 메시지. */
	private String secedeReasonMessage; // BOLTER_REASON_DESC
	...
	/** 대표 웹사이트. */
	private String repWebsite; // REP_EMAIL 대표웹사이트
