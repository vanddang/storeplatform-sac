...
public class RemoveDeviceRequest extends CommonInfo implements Serializable {
	...
	/**
	 * 사용자 휴대기기 Key List를 리턴한다.
	 * 
	 * @return deviceKey - 사용자 휴대기기 Key List
	 */
	public List<String> getDeviceKey() {
		return this.deviceKey;
	}

	/**
	 * 사용자 휴대기기 Key List를 설정한다.
	 * 
	 * @param deviceKey
	 *            사용자 휴대기기 Key List
	 */
	public void setDeviceKey(List<String> deviceKey) {
