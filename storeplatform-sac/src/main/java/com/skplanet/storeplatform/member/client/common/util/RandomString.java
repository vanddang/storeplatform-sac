...
public class RandomString {
	...
	public static void main(String[] args) {
		for (int i = 0; i < 100; i++) {
			...
			// + RandomString.getString(4, RandomString.TYPE_NUMBER + RandomString.TYPE_LOWER_ALPHA));
			// System.out.println("upper case + Number : "
			// + RandomString.getString(4, RandomString.TYPE_NUMBER + RandomString.TYPE_UPPER_ALPHA));
