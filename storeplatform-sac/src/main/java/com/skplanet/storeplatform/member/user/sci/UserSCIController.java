...
public class UserSCIController implements UserSCI {
	...
	public CheckDuplicationResponse checkDuplication(CheckDuplicationRequest checkDuplicationRequest) {
		...
		// 테넌트 아이디 없음
		if (checkDuplicationRequest.getCommonRequest().getTenantID() == null
				|| checkDuplicationRequest.getCommonRequest().getTenantID().length() <= 0) {
			throw new StorePlatformException(this.getMessage("response.ResultCode.tanentIDNotFound", ""));
		}
	...
	public SearchUserResponse searchUser(SearchUserRequest searchUserRequest) {
		...
		// 테넌트 아이디 없음
		if (searchUserRequest.getCommonRequest().getTenantID() == null
				|| searchUserRequest.getCommonRequest().getTenantID().length() <= 0) {
			throw new StorePlatformException(this.getMessage("response.ResultCode.tanentIDNotFound", ""));
		}
	...
	public UpdateStatusUserResponse updateStatus(UpdateStatusUserRequest updateStatusUserRequest) {
		...
		// 테넌트 아이디 없음
		if (updateStatusUserRequest.getCommonRequest().getTenantID() == null
				|| updateStatusUserRequest.getCommonRequest().getTenantID().length() <= 0) {
			throw new StorePlatformException(this.getMessage("response.ResultCode.tanentIDNotFound", ""));
		}
	...
	public SearchMemberPointResponse searchMemberPointList(SearchMemberPointRequest searchMemberPointRequest) {
		...
		// 테넌트 아이디 없음
		if (searchMemberPointRequest.getCommonRequest().getTenantID() == null
				|| searchMemberPointRequest.getCommonRequest().getTenantID().length() <= 0) {
			throw new StorePlatformException(this.getMessage("response.ResultCode.tanentIDNotFound", ""));
		}
	...
	public ExistListResponse existList(ExistListRequest existListRequest) {
		...
		// 테넌트 아이디 없음
		if (existListRequest.getCommonRequest().getTenantID() == null
				|| existListRequest.getCommonRequest().getTenantID().length() <= 0) {
			throw new StorePlatformException(this.getMessage("response.ResultCode.tanentIDNotFound", ""));
		}
