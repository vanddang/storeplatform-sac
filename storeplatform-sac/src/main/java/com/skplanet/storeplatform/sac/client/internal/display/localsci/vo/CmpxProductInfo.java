...
/**
 * 이용권 및 에피소드 상품 정보 조회 VO.
 * 
 * Updated on : 2015. 5. 07. Updated by : 김형식 , 지티소프트
 */
public class CmpxProductInfo extends CommonInfo {
	private static final long serialVersionUID = 1L;

	private String cmpxProdId;
	private String cmpxProdNm;
	private String cmpxProdPossLendClsfCd;
	...
	/**
	 * @param cmpxProdId the cmpxProdId to set
	 */
	...
	/**
	 * @return the cmpxProdPossLendClsfCd
	 */
	public String getCmpxProdPossLendClsfCd() {
		return cmpxProdPossLendClsfCd;
	}
	/**
	 * @param cmpxProdPossLendClsfCd the cmpxProdPossLendClsfCd to set
	 */
	public void setCmpxProdPossLendClsfCd(String cmpxProdPossLendClsfCd) {
		this.cmpxProdPossLendClsfCd = cmpxProdPossLendClsfCd;
	}
	/**
	 * @return the episodeProdId
	 */
	public String getEpisodeProdId() {
		return episodeProdId;
	}
	/**
	 * @param episodeProdId the episodeProdId to set
	 */
