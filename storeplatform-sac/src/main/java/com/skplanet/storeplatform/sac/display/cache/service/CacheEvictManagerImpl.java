...
public class CacheEvictManagerImpl implements CacheEvictManager {
    ...
    @Override
    @CacheEvict(value = {"sac:display:product:ebookcomic:v4","sac:display:product:ebookcomic:v5"}, key = "#param.getCacheKey()")
    ...
    @Override
    @CacheEvict(value = "sac:display:device:profile:v3", allEntries = true)
