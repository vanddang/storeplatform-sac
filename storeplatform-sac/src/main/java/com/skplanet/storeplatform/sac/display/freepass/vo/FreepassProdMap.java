...
public class FreepassProdMap {
	...
	/**
	 * @param partProdId the partProdId to set
	 */
	...
	public String getContentsClsfCd() {
		return contentsClsfCd;
	}
	/**
	 * @param contentsClsfCd the contentsClsfCd to set
	 */
	...
	/**
	 * @param settRate the settRate to set
	 */
	...
	/**
	 * @param drmUsePeriod the drmUsePeriod to set
	 */
	...
	/**
	 * @param drmSetClsfCd the drmSetClsfCd to set
	 */
	...
	/**
	 * @param iconClsfCd the iconClsfCd to set
	 */
