 ...
 */
public class CommonCode extends CommonInfo{
	...
	/**
	 * @param grpCdId the grpCdId to set
	 */
	...
	/**
	 * @param addField01 the addField01 to set
	 */
	...
	/**
	 * @param addField02 the addField02 to set
	 */
