...
public final class IdpConstants {
	...
	public static final String IDP_RESPONSE_SUCCESS_MSG = "SP 프로비져닝 성공";
	public static final String IDP_RESPONSE_FAIL_MSG = "SP 프로비져닝 실패(FAIL응답 받음)";
	public static final String IDP_RESPONSE_NO_DATA_MSG = "SP 프로비져닝 실패(데이터 없음)";
