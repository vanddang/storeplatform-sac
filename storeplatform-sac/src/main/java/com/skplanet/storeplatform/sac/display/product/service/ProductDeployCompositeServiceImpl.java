		...
		if (null != dpProd) {
			...
			if (!"".equals(prodId) && !"".equals(mbrNo)) {
				...
				try {
                    ...
                    String oldSellerNo = prodService.getProductSellerMbrNo(prodId);
					 ...
					 * 데이터 재구성
					 */
					this.builder.insertProdInfo(message, tempList, new HashSet<String>(existProdTenantList), oldSellerNo);
